    ...
    <div className="container">
      <div className="card" style={{ background: '#212121', marginBottom: 16 }}>
        <div className="spread">
          <div className="row">
            <div
              style={{ width: 10, height: 10, borderRadius: 999, background: '#00D4AA' }}
            />
          ...
          <div className="row">
            <button className="btn btnPrimary" onClick={() => alert('TODO: new task')}
              >new_task</button>
            <button className="btn" onClick={() => void refresh()}>refresh_log</button>
          </div>
        </div>
